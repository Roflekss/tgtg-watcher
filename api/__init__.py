...
USER_AGENTS = [
    "TooGoodToGo/26.1.10 (5455.0) (iPad/iPad Air 5th Gen (WiFi); iPadOS 26.2; Scale/2.00/iOS)",
]
...
class TgtgClient:
    def __init__(
        ...
        self.user_agent = user_agent if user_agent else "TooGoodToGo/26.1.10 (5455.0) (iPad/iPad Air 5th Gen (WiFi); iPadOS 26.2; Scale/2.00/iOS)"
